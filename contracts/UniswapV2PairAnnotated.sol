...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    /// #if_succeeds data.length == 0 ==> old(IERC20(_token0).balanceOf(_to)) + amount0Out == IERC20(_token0).balanceOf(_to);
    /// #if_succeeds data.length == 0 ==> old(IERC20(_token1).balanceOf(_to)) + amount1Out == IERC20(_token1).balanceOf(_to);
